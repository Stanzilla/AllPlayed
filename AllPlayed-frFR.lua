...
--        ["Horde"]                                               		= "Horde", 
        ...
        ["Hide characters from display"]                           		= "Hide characters from display",
        ["Hide %s of %s from display"]				            		= "Hide %s of %s from display",
		...
		["Show the honor related stats for all characters"]				= "Voir les points d'honneur de tous les personnages",
